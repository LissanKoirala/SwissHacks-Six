...
// homepage.png is the real home page straight from the app (2244×1510).
const SHOT_RATIO = 1510 / 2244;
...
export const DeskScene: React.FC<{ dur: number }> = ({ dur }) => (
  <Stage dur={dur} kicker="The morning desk">
    ...
    <div style={{ marginTop: 28, display: "flex", gap: 44, alignItems: "center", flex: 1 }}>
      ...
      <Appear at={22}>
        <Screenshot src="shots/homepage.png" width={960} ratio={SHOT_RATIO} />
      </Appear>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        <Appear at={54}>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 12 }}>
            <MetaChip>35 priority tasks</MetaChip>
